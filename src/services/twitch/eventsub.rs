...
use twitch_api2::helix::eventsub::{DeleteEventSubSubscription, DeleteEventSubSubscriptionRequest, CreateEventSubSubscriptionRequest, CreateEventSubSubscriptionBody, CreateEventSubSubscription};
...
use twitch_api2::helix::points::{UpdateRedemptionStatusRequest, UpdateRedemptionStatusBody, CustomRewardRedemptionStatus, UpdateRedemptionStatusInformation};

pub async fn delete_subscription(
    token: &AppAccessToken,
    id: String
) -> Result<(), Error> {
    let response: DeleteEventSubSubscription =
...
pub async fn subscribe_to_rewards(
    ...
    let response: Response<CreateEventSubSubscriptionRequest<ChannelPointsCustomRewardRedemptionAddV1>, CreateEventSubSubscription<ChannelPointsCustomRewardRedemptionAddV1>> =
        HelixClient::<'_, reqwest::Client>::default()
            .req_post(
                ...
                CreateEventSubSubscriptionBody::builder()
                    ...
                    .subscription(ChannelPointsCustomRewardRedemptionAddV1::builder().broadcaster_user_id(id).build())
                    .build(),
                token,
            )
            .await
...
pub async fn update_reward_redemption(broadcaster_id: &str, reward_id: &str, redemption_id: &str, status: CustomRewardRedemptionStatus, token: &UserToken) -> Result<(), Error> {
